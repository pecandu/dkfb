...
def loginSC():
	...
	if username =="ahmad" and password =="rofii":
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.youtube.com/pecandu mimpi')
				menu()
